...
export default function SustainabilityStats() {
  ...
  const cards = [
    {
      value: stats ? stats.totalCo2TrackedKg.toLocaleString() : "—",
      label: "Total CO\u2082 Tracked (kg)",
      icon: co2Icon,
    },
    {
      value: stats ? stats.actionsCount.toLocaleString() : "—",
      label: "Actions Logged",
      icon: offsetIcon,
    },
    {
      value: stats ? stats.totalPoints.toLocaleString() : "—",
      label: "Green Points Earned",
      icon: pointsIcon,
    },
    {
      value: stats?.ranking ? `#${stats.ranking}` : "Unranked",
